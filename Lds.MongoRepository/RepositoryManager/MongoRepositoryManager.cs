...
namespace Lds.MongoRepository.RepositoryManager {
  ...
  public class MongoRepositoryManager<T, TKey> : IRepositoryManager<T, TKey>
    ...
    public MongoRepositoryManager(IMongoDatabase database) {
    ...
    */
    ...
    {
      collection.Indexes.DropOne(keyname);
    }
...
/*    /// <summary>
    ...
    {
      var ixk = Builders<T>.IndexKeys; .Ascending("string");
